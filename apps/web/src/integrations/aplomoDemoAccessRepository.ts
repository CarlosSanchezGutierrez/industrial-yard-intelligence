...
export const APLOMO_DEMO_ROLE_ACCOUNTS: readonly AplomoDemoRoleAccount[] = [
  ...
  { accountKey: "platform_aplomo_admin", email: "demo+aplomo-admin@aplomodemo.test", displayName: "Demo Aplomo Admin", accountScope: "platform", platformRole: "aplomo_admin", tenantRole: "tenant_admin", intendedEntrypoint: "/aplomo-admin", description: "Administracion interna de plataforma." },
  ...
  { accountKey: "tenant_owner", email: "demo+tenant-owner@aplomodemo.test", displayName: "Demo Tenant Owner", accountScope: "tenant", platformRole: "none", tenantRole: "tenant_owner", intendedEntrypoint: "/aplomo-admin", description: "Dueno de empresa cliente." },
  ...
  { accountKey: "site_supervisor", email: "demo+site-supervisor@aplomodemo.test", displayName: "Demo Site Supervisor", accountScope: "tenant", platformRole: "none", tenantRole: "site_supervisor", intendedEntrypoint: "/aplomo-admin", description: "Supervisor de patio o site." },
  { accountKey: "capture_operator", email: "demo+capture-operator@aplomodemo.test", displayName: "Demo Capture Operator", accountScope: "tenant", platformRole: "none", tenantRole: "capture_operator", intendedEntrypoint: "/aplomo-admin", description: "Capturista GPS y celular." },
...
export async function signOutAplomoDemoAccount(): Promise<void> {
  ...
  if (result.error) {
    throw new Error(result.error.message ?? "No se pudo cerrar sesion.");
  }
}
