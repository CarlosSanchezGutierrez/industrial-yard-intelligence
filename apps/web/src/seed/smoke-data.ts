...
export interface SmokeKpi {
  ...
  readonly classification: "simulated" | "estimated" | "operational";
}

export const smokeKpis: readonly SmokeKpi[] = [
  {
...
export const smokeStockpiles: readonly SmokeStockpile[] = [
  {
...
export const smokeEquipment: readonly SmokeEquipment[] = [
  {
    id: "crane_arthur",
    name: "Arthur",
    type: "Grúa Clyde 24",
